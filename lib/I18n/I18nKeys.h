...
enum class StrId : uint16_t {
  ...
  STR_WEATHER,
  STR_WEATHER_TITLE,
  STR_WEATHER_LOCATION,
  STR_WEATHER_SET_LOCATION,
  STR_WEATHER_HIGH,
  STR_WEATHER_LOW,
  STR_WEATHER_PRECIP,
  STR_WEATHER_CURRENT,
  STR_WEATHER_NO_LOCATION,
  STR_WEATHER_FETCHING,
  STR_WEATHER_FETCH_FAILED,
  STR_WEATHER_USE_FAHRENHEIT,
  STR_WEATHER_ENTER_LOCATION,
  STR_WEATHER_ENTER_LATITUDE,
  STR_WEATHER_ENTER_LONGITUDE,
  STR_WEATHER_LOCATION_NAME,
  STR_WEATHER_CLEAR,
  STR_WEATHER_CLOUDY,
  STR_WEATHER_RAIN,
  STR_WEATHER_SNOW,
  ...
  STR_WEATHER_FOG,
  STR_WEATHER_REFRESH,
  STR_WEATHER_CONFIGURE,
  STR_WEATHER_SEARCH_LOCATION,
  STR_WEATHER_SEARCHING_FOR,
  STR_WEATHER_RESULTS_FOR,
  STR_WEATHER_NO_RESULTS_FOR,
  STR_WEATHER_TRY_AGAIN,
